  ...
  return (
    <div className="bg-slate-950 text-slate-200 min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="max-w-4xl mx-auto">
                {/* Matrix Container */}
                <div className="relative aspect-square bg-slate-900/30 backdrop-blur border border-slate-700 rounded-xl p-8">
                  {/* Axis Labels */}
                  <div className="absolute top-4 left-1/2 -translate-x-1/2 text-sm font-bold text-cyan-400">
                    BREAKTHROUGH
                  </div>
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-sm font-bold text-slate-500">
                    STAGNATION
                  </div>
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 -rotate-90 text-sm font-bold text-blue-400">
                    COOPERATION
                  </div>
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 rotate-90 text-sm font-bold text-red-400">
                    FRAGMENTATION
                  </div>
                  ...
                  {/* Quadrants */}
                  <div className="grid grid-cols-2 grid-rows-2 gap-0 h-full p-8">
                    {/* Top-Left: New Frontier */}
                    <motion.div
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className="text-xs text-slate-500 mt-2">Click to explore</div>
                      </div>
                    </motion.div>

                    {/* Top-Right: Star Rivals */}
                    <motion.div
                      whileHover={{ scale: 1.05 }}
                    ...
                    {/* Bottom-Right: Cold Orbit */}
                    <motion.div
                      whileHover={{ scale: 1.05 }}
                      onClick={() => setActiveScenario('cold-orbit')}
                      className="flex items-center justify-center p-6 cursor-pointer group"
                    >
                      <div className="text-center">
        ...
        {/* The 4 Scenarios - Interactive Tabs */}
        <section className="py-20 px-4 bg-slate-950/50">
          <div className="max-w-7xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
                ...
                {activeScenario === 'cold-orbit' && (
                  ...
                  >
                    <h3 className="text-3xl font-bold text-red-400 mb-6">
                      Cold Orbit: Fragmented Stagnation
                    </h3>
                    
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                        <h4 className="text-xl font-bold text-red-300 mb-3">Military Dominance</h4>
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start gap-2">
                            <Shield className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" />
                            <span>Military and security applications dominate space</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Shield className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" />
                            <span>Civil and commercial activity heavily constrained</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Shield className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" />
                            <span>Access to space tightly controlled</span>
                          </li>
                        </ul>
                      </div>

                      <div>
                        <h4 className="text-xl font-bold text-red-300 mb-3">Investment Retreat</h4>
                        <ul className="space-y-2 text-slate-300">
                          <li className="flex items-start gap-2">
                            <Shield className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" />
                            <span>Private investment retreats due to geopolitical risks</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Shield className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" />
                            <span>Technological innovation stagnates</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Shield className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" />
                            <span>Space sector contracts significantly</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="mt-8 p-6 bg-red-500/10 border border-red-500/30 rounded-lg">
                      <p className="text-red-200 font-semibold">
                        <strong>Strategic Implication:</strong> State backing becomes essential for survival. Private actors must align with government priorities.
                      </p>
                    </div>
                  </motion.div>
                )}
